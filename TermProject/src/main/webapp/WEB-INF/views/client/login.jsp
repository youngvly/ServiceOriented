...
<head>
    <meta charset="UTF-8">
    <title>http://www.service.co.kr</title>
        ...
        <div class="content">
            <div class="signin-cont cont">
                ...
                <form action="j_spring_security_check" method="post" enctype="multipart/form-data">
                    <input type="email" name="j_username" id="email" class="inpt" required="required" placeholder="Your email">
                    <label for="email">Your email</label>
                    <input type="password" name="j_password" id="password" class="inpt" required="required" placeholder="Your password">
                    <label for="password">Your password</label>
                    <input type="checkbox" id="remember" class="checkbox" checked>
                    <label for="remember">Remember me</label>
                    <div class="submit-wrap">
                        <input type="button" value="카카오 로그인" onclick="window.location.href='/oauth/kakao_authorization_code'" class="submit">
                        <br>
            ...
            <div class="signup-cont cont">
                <form:form action="register" modelAttribute="user" enctype="multipart/form-data" method="post">
                    <form:input path= "name" type="name"  name="name" id="name" class="inpt" required="required" placeholder="Your name"/>
                    <label for="name">Your name</label>
                    <form:input path= "email" type="email" name="email" id="email" class="inpt" required="required" placeholder="Your email"/>
                    <label for="email">Your email</label>
                    <form:input path= "password" type="password" name="password" id="password" class="inpt" required="required" placeholder="Your password"/>
                    <label for="password">Your password</label>
                    <form:input  path= "age" type="name" name="age" id="age" class="inpt" required="required" placeholder="Your Age"/>
