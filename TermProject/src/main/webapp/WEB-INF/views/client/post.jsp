...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand" href="/client/index.jsp">Start Bootstrap</a>
        ...
        <div class="row">
          <div class="col-lg-8 col-md-10 mx-auto">
            ...
            <table>
              ...
              <tr>
                <td>공채 속보와 기업 최신뉴스 API</td>
                <td>GET</td>
                <td>--</td>
                <td>http://testappelasticbeanstalk-prod.hhm2ctb7ye.ap-northeast-2.elasticbeanstalk.com/jobinfo/api/</td>
                <td>JSON/XML</td>
                <td>매일 업데이트되는 공채 속보와 기업별 최신뉴스</td>
              </tr>
            </table>
            <p>2. 요청변수</p>
            <p>2.1 공채 속보와 기업 최신뉴스 API</p>
            <table>
              <th>
                <td>요청변수명</td>
                <td>타입</td>
