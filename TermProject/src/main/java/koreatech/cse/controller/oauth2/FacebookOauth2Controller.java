...
public class FacebookOauth2Controller {
    ...
    private String facebook_authorization_endpoint = "https://www.facebook.com/dialog/oauth";
    private String facebook_token_endpoint = "https://graph.facebook.com/v3.2/oauth/access_token";
    private String facebook_redirect_uri = "http://localhost:8080/oauth/facebook_callback";
